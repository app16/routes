...
module.exports = function(app) {    
    app.post("/uploadHist", (req, res) => {
        ...
        connection.query("INSERT INTO History (PatientID, SessionDate, ProviderID, Comments) VALUES ('"+ req.body.patID +"','"+ req.body.sesDate +"','"+  req.body.proID +"','"+ req.body.comm+"');", function(err, rows) {
        if (!err) {
        ...
        connection.end(); 
            ...
            try {
                ...
                const issueResponse = await contract.submitTransaction('upload', req.body.patID,'History', HistID);
